...
>(({ defaultOpen = true, isOpen: openProp, onOpenChange: setOpenProp, className, children, ...props }, ref) => {
	...
	return (
		<SidebarContext.Provider value={contextValue}>
			<div
				className={cn(
					"relative group/sidebar-wrapper [--sidebar-width:16.5rem] [--sidebar-width-icon:3rem] flex min-h-svh w-full text-fg dark:has-[[data-intent=inset]]:bg-bg has-[[data-intent=inset]]:bg-secondary/50",
					className,
				)}
				ref={ref}
				{...props}
