// Generated by Wrangler by running `wrangler types` (hash: 21aa5d8847e30dbc32ebc7fa62d7cc63)
...
declare namespace Cloudflare {
	interface Env {
		...
		DETECT_DIRECT_TRANSACTIONS_WORKFLOW: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_GOOGLE_CLIENT_ID" | "VITE_ELECTRIC_UR" | "LOG_LEVEL" | "IS_DEV" | "GO_CARDLESS_SECRET_ID" | "GO_CARDLESS_SECRET_KEY" | "VITE_BASE_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
